...
debug=y
base=/Volumes/JD/scripts	# set me to where this script, and the 2 convert scripts are 
...
thePassword=password		# enter your socs (ldap) password in plain text here
...
theSocsCalendar1=jd51229
theCalendar1=Sun

theSocsCalendar2=jd51229:home
theCalendar2=Home

#theSocsCalendar3=jd51229:billing
#theCalendar3=Billing
...
CONVERT_TZ=~/scripts/convert_tz.sh
...
#cat /tmp/CAFsync$theCalendar2 | ~/scripts/convert_tz.sh > /tmp/CAFsync${theCalendar2}_TZ
cat /tmp/CAFsync$theCalendar2 |~/scripts/convert_tz.sh |~/scripts/convert_to_private.sh >/tmp/CAFsync${theCalendar2}_TZ
