...
#
# Updates:	02-Dec-2011	v0.5	driscolj	intital script created
# 		02-Dec-2011	v1.0	driscolj	intital script to Brett Helies
# 		05-Dec-2011	v1.1	driscolj	changed capacity loopt to collect 512 and 520-byte fields
#		
#
### VARIABLES

OLDLINE=""
DATA1=`echo $1.stripped`
...
# get the number of lines to process (from the parsed output)
TOTALCOUNT=`cat $DATA1 | wc -l`

# create column headers for outfile
echo Device,Blocksize,Capacity > $DATA2
...
if [ $COUNT2 -le $SCALE ]
 then
	...
	PERCENT=`echo "scale=0;$COUNT*100/$TOTALCOUNT"|bc`
