...
time /usr/local/bin/rsync --rsync-path=/usr/local/bin/rsync -vaz -P --delete --showtogo --link-dest="/Volumes/fred/JD-bak-rotate/jd-bak.1/" "/Volumes/JD/testing" "/Volumes/fred/JD-bak-rotate/jd-bak.0/"
