...
#
	...
	printf "%-53s %-40s %-6s < [ average (ms): %-3s | %-4s | %-4s | %-4s | %-4s ] \n" "$NAME4 ---" "$goog_av_bar" "$goog_average ms" "$goog_average_1min" "$goog_average_5min" "$goog_average_10min" "$goog_average_30min" "$goog_average"
