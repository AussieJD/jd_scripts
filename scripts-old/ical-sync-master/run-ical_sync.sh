...
#		Dec 2004, jon.driscoll@sun.com, added more VARIABLES for simpler portability
#
#
# record env HTTP_PROXY

debug=y
base=/Volumes/JD/scripts
...
thePassword=PASSWORD			# ##### CHANGE ME #####
...
#theSocsCalendar1=jd51229:mac-sun-cal
